...
public class JarListener {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String jarPath = "/home/harshit/Documents/IAS/ser.jar";
	...
	public static void updateServiceRepo(List<String> services)
	{
		...
		jsonObject.put("ip", "10.2.129.220");
		...
		jsonObject.put("services", services);
		  ...
		  WebResource service = client.resource("http://10.3.1.84:8080/test1/updateRepoMapping/" + encStr);
